...
import com.kidc.indexselector.indexablerv.database.DataObserver;
import com.kidc.indexselector.indexablerv.database.HeaderFooterDataObserver;
import com.kidc.indexselector.indexablerv.database.IndexBarDataObserver;
...
public class IndexAbleLayout extends FrameLayout {
    ...
    private HeaderFooterDataObserver<EntityWrapper> mHeaderFooterDataSetObserver =
            new HeaderFooterDataObserver<EntityWrapper>() {
        @Override
    ...
    private <T extends IndexAbleEntity> void initStickyView(final IndexAbleAdapter<T> adapter) {
        mStickyViewHolder = adapter.onCreateTitleViewHolder(mRecyclerView);
