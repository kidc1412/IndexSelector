...
class IndexBar extends View {
    ...
    private ArrayList<EntityWrapper> mData;
...
//        }
    ...
    void setSelection(int firstVisibleItemPosition) {
        if (mData == null || mData.size() <= firstVisibleItemPosition || firstVisibleItemPosition < 0)
            return;
        EntityWrapper wrapper = mData.get(firstVisibleItemPosition);
